...
<RoundedImage
  ...
  src={`/content-marketing-personal-brand/originally-posted.png`}
  width={1913}
  height={589}
/>
...
<RoundedImage
  ...
  src={`/content-marketing-personal-brand/reddit.png`}
  width={1680}
  height={184}
/>
...
<RoundedImage
  alt={`Article Initially Posted`}
  src={`/content-marketing-personal-brand/final-views.png`}
  width={955}
  height={472}
/>
