...
<RoundedImage
  alt={`Redux Growth`}
  src={`/react-state-management/redux.png`}
  width={1000}
  height={586}
/>
...
<RoundedImage
  alt={`React Context`}
  src={`/react-state-management/context.png`}
  width={1000}
  height={572}
/>
...
<RoundedImage
  alt={`Figma`}
  src={`/react-state-management/figma.png`}
  width={1000}
  height={663}
/>
...
<RoundedImage
  ...
  src={`/react-state-management/immer.png`}
  width={1000}
  height={389}
/>
...
<RoundedImage
  ...
  src={`/react-state-management/amazon.png`}
  width={1000}
  height={732}
/>
...
<RoundedImage
  ...
  src={`/react-state-management/nomad.png`}
  width={1000}
  height={676}
/>
