...
3.  Navigate to "Database" and click "Create Database".
    ![text](/images/real-time-post-views/firebase/step1.png)
4.  Start in test mode and click next.
    ![text](/images/real-time-post-views/firebase/step2.png)
5.  Choose your database location and click done.
    ![text](/images/real-time-post-views/firebase/step3.png)
6.  In the top left, click on "Project Settings".
    ![text](/images/real-time-post-views/firebase/step4.png)
7.  Navigate to "Service Accounts" tab and click "Generate new private key". Save the `.json` file. You will need this later.
    ![text](/images/real-time-post-views/firebase/step5.png)  
...
![text](/images/real-time-post-views/testing-database.png)
...
![text](/images/real-time-post-views/blog-post-views.png)
...
![text](/images/real-time-post-views/db-usage.png)
