...
summary: 'Explore the possibilities of time travel through an immersive website for a fictional travel agency, complete with dynamic destination timelines and interactive historical events.'
publishedAt: 'Oct 2 2023'
image: '/project-2.jpg'
